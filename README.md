...
* **[main.py](main.py)**: System orchestrator. Manages thread boundaries, signal handlers (`SIGINT`/`SIGTERM`), and main-thread Tkinter Cocoa execution.
...
* **[llm_engine.py](llm_engine.py)**: Ollama chat orchestrator with conversation memory buffer pruning (20 messages max), regex sentence splitting, and deterministic tool routing.
